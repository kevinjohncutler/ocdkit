...
const DEBUG_GRID_LINE_LABEL = 1;
  ...
  function isGridLoggingEnabled() {
    if (typeof globalThis !== 'object' || !globalThis.__VIEWER_DEBUG__) {
      return false;
    }
    return Boolean(globalThis.__VIEWER_DEBUG__.gridLogs);
  }
...
const ENABLE_DEBUG_GRID_MASK = (() => {
  ...
  function updateMaskReference(array, forceNotify = false) {
    ...
    if (typeof notify === 'function') {
      try {
        ...
        // issue #8: surface silent error so debugger sees the failure.
        console.warn('[painting] onMaskBufferReplaced notify threw:', err);
      }
    }
    if (state.maskPipeline && typeof state.maskPipeline.onMaskBufferReplaced === 'function') {
      try {
        ...
        console.warn('[painting] maskPipeline.onMaskBufferReplaced threw:', err);
      }
    }
  ...
  function seedDebugGridMask(ctx, width, height) {
    ...
    if (typeof globalThis !== 'undefined') {
      globalThis.__VIEWER_DEBUG__ = globalThis.__VIEWER_DEBUG__ || {};
      globalThis.__VIEWER_DEBUG__.gridSeedAttempts = (globalThis.__VIEWER_DEBUG__.gridSeedAttempts || 0) + 1;
    }
    ...
    const backgroundLabel = (typeof globalThis !== 'undefined'
      && globalThis.__VIEWER_DEBUG__
      && typeof globalThis.__VIEWER_DEBUG__.gridBackgroundLabel === 'number')
      ? (globalThis.__VIEWER_DEBUG__.gridBackgroundLabel | 0)
      : DEBUG_GRID_BACKGROUND_LABEL;
    if (typeof globalThis !== 'undefined') {
      globalThis.__VIEWER_DEBUG__ = globalThis.__VIEWER_DEBUG__ || {};
      globalThis.__VIEWER_DEBUG__.gridBackgroundLabel = backgroundLabel;
      globalThis.__VIEWER_DEBUG__.gridLineLabel = DEBUG_GRID_LINE_LABEL;
    }
  ...
  function finalizeComponentFill(
    ...
    if (typeof global.__VIEWER_DEBUG__ === 'object') {
      const history = global.__VIEWER_DEBUG__.finalizeHistory || (global.__VIEWER_DEBUG__.finalizeHistory = []);
      history.push({
