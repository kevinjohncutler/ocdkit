...
The viewer ships with the same JS/CSS/HTML layout that originally lived under
``omnipose/gui/web/``. Plugins do not customize this — they declare widget
specs and the frontend renders them into the existing settings pane.
"""
...
def build_html(config: Mapping[str, Any], *, inline_assets: bool = True) -> str:
    return render_index(dict(config), inline_assets=inline_assets)
