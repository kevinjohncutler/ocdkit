...
def start_trust_setup_sidecar(host: str, port: int) -> None:
    ...
    HTTPS server (hostpkg, omnipose, bare FastAPI, etc.).
    """
...
def run_server(
    ...
    *,
    ...
    Apps embedding the viewer (hostpkg, omnipose, etc.) should ship their own
...
def run_desktop(
    *,
    ...
    app_name:
        ...
        omnirefactor, hostpkg) calls this function it should pass its own
